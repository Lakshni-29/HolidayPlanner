...
if($decoded->data[$i]->itineraries[0]->segments[0]->carrierCode == "KE")
{
  $airname[$i]=nl2br("Korean Air");
  $path[$i]="images/logo5.jpeg";
}
...
$dat[$i]=ltrim(ltrim(ltrim(chop(chop(ltrim($decoded->data[$i]->itineraries[0]->segments[0]->arrival->at,"2022"),"$at[$i]"),"T"),"-0"),"2"),"-");
...
$b[$i]=$decoded->data[$i]->itineraries[0]->segments[0]->arrival->iataCode;
}
            ...
            <div class="ow-tuple-container__details ms-grid-row-2" data-testid="airlineBlock" style="background-color:aliceblue;" id="mydiv">
                ...
                <div class="ms-grid-column-2" style="margin-top: 50px;margin-left: 50px;">
                    <div class="ow-tuple-container__details__time ms-grid-row-2" style="margin-top: 20px;">
                        ...
                        <div class="ms-grid-column-1 ms-grid-row-2" style="grid-column: span 2 / auto;margin-left:40px;">
