...
{
  $airname[$i]="Air India";
  $path[$i]="images/logo1.png";
}
else
{
  $airname[$i]="Vistara";
  $path[$i]="images/logo.jpg";
}
    ...
    <body>
        <div class="booking-content" style="position: relative;background-color: white;">
            ...
            <div class="ow-tuple-container__details ms-grid-row-2" data-testid="airlineBlock" style="background-color:aliceblue;" id="mydiv">
                    ...
                    <div class="flex flex-column flex-start">
                        <div class="flex flex-row nmx-1">
                            <div class="" data-tooltipped="" aria-describedby="tippy-tooltip-1" data-original-title="undefined" style="display: flex;">
                                <img src="
															<?php echo $path[0] ?>" alt="Air India" class="br-2 o-hidden mx-1" style="width: 60px; height: 60px;">
                ...
                <div class="ow-tuple-container_details_price flex ms-grid-column-3" style="margin-top: 50px;">
                ...
                <div class="flex flex-start ms-grid-column-1" style="margin-top: 10px;margin-left: 20px;width: 150px;">
                    <div class="flex flex-column flex-start">
                        <div class="flex flex-row nmx-1">
                            <div class="" data-tooltipped="" aria-describedby="tippy-tooltip-1" data-original-title="undefined" style="display: flex;">
                                <img src="
																<?php echo $path[1] ?>" alt="Air India" class="br-2 o-hidden mx-1" style="width: 60px; height: 60px;">
                ...
                <div class="flex flex-start ms-grid-column-1" style="margin-top: 10px;margin-left: 20px;width: 150px;">
                    <div class="flex flex-column flex-start">
                        <div class="flex flex-row nmx-1">
                            <div class="" data-tooltipped="" aria-describedby="tippy-tooltip-1" data-original-title="undefined" style="display: flex;">
                                <img src="
																	<?php echo $path[2] ?>" alt="Air India" class="br-2 o-hidden mx-1" style="width: 60px; height: 60px;">
                ...
                <div class="flex flex-start ms-grid-column-1" style="margin-top: 10px;margin-left: 20px;width: 150px;">
                    <div class="flex flex-column flex-start">
                        <div class="flex flex-row nmx-1">
                            <div class="" data-tooltipped="" aria-describedby="tippy-tooltip-1" data-original-title="undefined" style="display: flex;">
                                <img src="
																		<?php echo $path[3] ?>" alt="Air India" class="br-2 o-hidden mx-1" style="width: 60px; height: 60px;">
                ...
                <div class="flex flex-start ms-grid-column-1" style="margin-top: 10px;margin-left: 20px;width: 150px;">
                    <div class="flex flex-column flex-start">
                        <div class="flex flex-row nmx-1">
                            <div class="" data-tooltipped="" aria-describedby="tippy-tooltip-1" data-original-title="undefined" style="display: flex;">
                                <img src="
																			<?php echo $path[4] ?>" alt="Air India" class="br-2 o-hidden mx-1" style="width: 60px; height: 60px;">
