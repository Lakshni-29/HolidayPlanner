                  ...
                  <div class="plan-header-wrap">
                     <div class="plan-header-center ">
                        ...
                        <nav id="plan-nav" class="plan-nav">
                           <ul class="tabs tab-pane">
                              <li title="Route" class="tab-overview tab-element " data-target="overview" data-add-btn-label="+ Add">
                                 <a href="../planner.html">Route</a>
                              </li>
                              <li title="Where to stay" class="tab-itinerary tab-element active" data-target="itinerary" data-subnav="Timeline" data-add-btn-label="+ Add">
                                 <a href="javascript:void(0);">
                                    <a href="hotel/hotel1.php">Where to stay</a>
                                 </a>
                              </li>
                              <li title="Checklist" class="tab-hotels tab-element " data-target="hotels" data-add-btn-label="+ Add">
                                 <a href="../check/checklist2.html">Checklist</a>
                              </li>
                              <li title="Bucketlist" class="tab-checklist tab-element " data-target="checklist" data-add-btn-label="+ Add">
                                 <a href="../list.html">Bucketlist</a>
                              </li>
                              <li id="action-alerts" class="action" data-non-tab="true">
                                 <span class="notification-wrapper">
                                    <svg class="notification">
                                       <use xlink:href="#icon-notification"></use>
                                    </svg>
                                    <span class="num-notifications notranslate">0</span>
                                 </span>
                              </li>
                           </ul>
                        </nav>
                        <ul class="plan-actions right">
                           <li id="action-btn" class="action" data-print-link="/trip/10-days-in-south-korea-itinerary-in-february-ff600c16-e46c-4611-9f28-00d363b3a589/print" data-share-enabled="true" data-cotraveler-enabled="true" data-has-cotravelers="false" data-print-enabled="true">
                              <svg class="settings">
                                 <!-- <use xlink:href="#icon-settings"></use> -->
                              </svg>
                              <div class="settings-facade"></div>
                           </li>
                        </ul>
                     </div>
                  </div>
